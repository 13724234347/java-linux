...
public class PartitionConsumerTest {
	public static void main(String args[]) {
		...
		String hosts="192.168.1.138,192.168.1.175,192.168.1.180";
        ...
        int partLen = Integer.parseInt("1");
	    try {
	        example.run(maxReads, topic, partLen/*partition*/, seeds, port);
	    } catch (Exception e) {
	        System.out.println("Oops:" + e);
	        e.printStackTrace();
	    }
//		for(int index=0;index < partLen;index++){
//			System.err.println(index+"区");
//			System.out.println();
//	        try {
